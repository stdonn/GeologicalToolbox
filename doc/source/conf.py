# -*- coding: utf-8 -*-
#
# Geological Toolbox documentation build configuration file, created by
...
version = u'.'.join(project_version[:3])
# The full version, including alpha/beta/rc tags.
release = u'.'.join(project_version)
...
latex_documents = [
    (master_doc, 'GeologicalToolbox.tex', u'Geological Toolbox Documentation',
